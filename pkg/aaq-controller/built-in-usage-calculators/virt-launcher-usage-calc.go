...
func (launchercalc *VirtLauncherCalculator) PodUsageFunc(pod corev1.Pod, podsState []corev1.Pod) (corev1.ResourceList, error, bool) {
	...
	launcherPods := UnfinishedVMIPods(podsState, vmi)
