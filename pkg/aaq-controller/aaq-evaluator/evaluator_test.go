...
var _ = Describe("AaqEvaluator", func() {
	Context("Test usage func", func() {
		...
		BeforeEach(func() {
			...
			eval = NewAaqEvaluator(podInformer, newAaqEvaluatorsRegistry(1, "/fakeSocketSharedDirectory"), fakeClock)
		})
	...
	Context("Test UsageStats func", func() {
		...
		DescribeTable("Test pod UsageStats when ", func(objs []metav1.Object, expectedUsage corev1.ResourceList,
			...
			evaluator := NewAaqEvaluator(podInformer, newAaqEvaluatorsRegistry(1, "/fakeSocketSharedDirectory"), fakeClock)
