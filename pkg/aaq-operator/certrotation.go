...
func (cm *certManager) Sync(certs []aaqcerts.CertificateDefinition) error {
...
func (cm *certManager) ensureSigner(cd aaqcerts.CertificateDefinition) (*crypto.CA, error) {
...
func (cm *certManager) ensureCertConfig(secret *corev1.Secret, certConfig aaqcerts.CertificateConfig) (*corev1.Secret, error) {
...
func (cm *certManager) ensureCertBundle(cd aaqcerts.CertificateDefinition, ca *crypto.CA) ([]*x509.Certificate, error) {
...
func (cm *certManager) ensureTarget(cd aaqcerts.CertificateDefinition, ca *crypto.CA, bundle []*x509.Certificate) error {
	listers, ok := cm.listerMap[cd.SignerSecret.Namespace]
	if !ok {
