...
var excludedMetrics = map[string]struct{}{
	// Backward-compatibility alias exposed via recording rule; keep as-is
	"kube_application_aware_resourcequota_creation_timestamp": {},
	// Base kube metric name (top-level) – linter expects an additional segment after the prefix
	"kube_application_aware_resourcequota": {},
	// Timestamp metric: linter currently flags despite correct kube_application_aware_ prefix
